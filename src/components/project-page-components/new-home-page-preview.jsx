  ...
  return(
    <Box>
      ...
      <Box position="relative" mt={{ base: "2rem", md: "4rem" }}>
        <Box maxW="1100px" bg="rgba(90, 93, 159, 0.6)" p={{base: '1rem', lg: '4rem'}} style={{ borderRadius: '8px' }}>
        ...
        <Box
          ...
          right={isLgOrLarger ? { base: '1rem', md: '-2rem' } : "auto"}
        ...
        >
          ...
          <Box p="1rem" borderRadius="8px" bg="#1a1a1a" border="solid 1px #5A5D9F" width="100%">
          <Text size="lg">KEY RESULTS</Text>
            </Box>
            <Box p="1.5rem" borderRadius="8px" bg="#1a1a1a" border="solid 1px #5A5D9F">
